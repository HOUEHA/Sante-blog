...
echo "=== ALIMENTATION DU CONTENU PRINCIPAL ===\n\n";

// Articles pour la catégorie Alimentation
...
<p>Adopter ces principes fondamentaux vous mettra sur la voie d\'une alimentation saine et durable. N\'oubliez pas que la modération et la variété sont les clés du succès.</p>',
        'image_url' => '/images/alimentation-saine.jpg',
        'reading_time' => 8,
        'is_published' => true,
        'meta_title' => 'Les Fondamentaux d\'une Alimentation Saine | Blog Santé',
        'meta_description' => 'Guide complet sur les principes d\'une nutrition équilibrée pour une vie saine.',
...
<p>Intégrer ces super-aliments progressivement dans votre alimentation vous apportera des bienfaits visibles sur votre énergie et votre santé globale.</p>',
        'image_url' => '/images/super-aliments.jpg',
        'reading_time' => 6,
        'is_published' => true,
        'meta_title' => 'Les Super-Aliments Essentiels | Blog Santé',
        'meta_description' => 'Découvrez les super-aliments à intégrer dans votre alimentation quotidienne.',
        'tags' => json_encode(['super-aliments', 'nutrition', 'santé', 'bien-être'])
    ]
];

// Articles pour la catégorie Prévention
$preventionArticles = [
    [
...
<p>La vaccination est un acte de responsabilité individuelle et collective. Consultez votre médecin pour un calendrier personnalisé.</p>',
        'image_url' => '/images/vaccination-prevention.jpg',
        'reading_time' => 10,
        'is_published' => true,
        'meta_title' => 'Vaccins Essentiels à Tout Âge | Blog Santé',
        'meta_description' => 'Guide complet sur les vaccins recommandés pour une protection optimale.',
        'tags' => json_encode(['vaccination', 'prévention', 'santé publique', 'immunité'])
    ],
    [
...
<p>Prioriser le sommeil est un investissement dans votre santé à long terme. Un sommeil de qualité améliore votre énergie, votre humeur et votre immunité.</p>',
        'image_url' => '/images/sommeil-sante.jpg',
        'reading_time' => 8,
        'is_published' => true,
        'meta_title' => 'Importance du Sommeil pour la Santé | Blog Santé',
        'meta_description' => 'Comprendre l\'importance du sommeil et ses bienfaits sur la santé.',
        'tags' => json_encode(['sommeil', 'prévention', 'santé', 'bien-être'])
    ]
];

// Articles pour la catégorie Interviews et Témoignages
$interviewArticles = [
    [
        'title' => 'Interview: Dr. Martin, Cardiologue sur la Prévention Cardiovasculaire',
        'slug' => 'interview-dr-martin-cardiologue',
        'category_slug' => 'interview-et-temoignage',
...
<p>Cette interview avec le Dr. Martin nous rappelle l\'importance de la prévention cardiovasculaire. Des gestes simples au quotidien peuvent faire toute la différence.</p>',
        'image_url' => '/images/interview-dr-martin.jpg',
        'reading_time' => 12,
        'is_published' => true,
        'meta_title' => 'Interview Dr. Martin Cardiologue | Blog Santé',
        'meta_description' => 'Interview exclusive du Dr. Martin sur la prévention cardiovasculaire.',
        'tags' => json_encode(['interview', 'cardiologue', 'prévention', 'cœur'])
    ],
    [
...
<p>Le témoignage de Sophie nous montre que transformer son alimentation est possible avec de la persévérance et des changements progressifs. Les bienfaits dépassent largement les efforts fournis.</p>',
        'image_url' => '/images/temoignage-sophie.jpg',
        'reading_time' => 10,
        'is_published' => true,
        'meta_title' => 'Témoignage Sophie Alimentation Saine | Blog Santé',
        'meta_description' => 'Témoignage inspirant de Sophie sur son parcours vers une alimentation saine.',
        'tags' => json_encode(['témoignage', 'alimentation', 'transformation', 'santé'])
    ]
];

// Fusionner tous les articles
$allArticles = array_merge($alimentationArticles, $preventionArticles, $interviewArticles);
